...
# Nguồn duy nhất của 5 câu hỏi: data/benchmark_queries.py (đã chốt ở REPORT_NHOM.md
# mục 3). Trước đây bench.py giữ một bản sao và bản sao đó đã trôi khỏi bản gốc —
# số benchmark trong báo cáo cá nhân vì thế không tái lập được. Import thẳng để
# không thể lệch lần nữa.
from data.benchmark_queries import QUERIES  # noqa: E402
